...
class CalculadoraResistenciasScreen2 extends StatelessWidget {
  const CalculadoraResistenciasScreen2({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Calculadora de Resistencias de 4 bandas"),
        ),
    ...
    return Form(
      ...
      child: Column(
        children: [
          ...
          const Image(width: 200, image: AssetImage("assets/resistencia.png")),
          const SizedBox(height: 20),
          CustomDropdown(
            formData: formData,
            formProperty: "banda1",
